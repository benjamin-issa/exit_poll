...
## has phone number 1 only
      if val1 == True and val2 == False and val3 == False:
        num1.save()
...
## has phone number 2 only
      if val1 == False and val2 == True and val3 == False:
        num2.save()
...
## has phone number 3 only
      if val1 == False and val2 == False and val3 == True:
        num3.save()
...
## has phone number 1 and 3 only     
      if val1 == True and val2 == False and val3 == True:
        num1.save()
        num3.save()
...
## has phone number 2 and 3 only 
      if val1 == False and val2 == True and val3 == True:
        num2.save()
        num3.save()
...
## no phone in file
      if val1 == False and val2 == False and val3 == False:
        res = Voter(name=fname,respondent_id =r_id,respondent_age =age, spanish_speaking =s_speaking, respondent_wave = r_wave, done_online_survey=done_survey)
      res.save()